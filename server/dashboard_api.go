...
func (svr *Service) registerRouterHandles(helper *httppkg.RouterRegisterHelper) {
	...
	subRouter.HandleFunc("/apo/proxies", svr.deleteProxies).Methods("DELETE")
...
func (svr *Service) apiProxyByType(w http.ResponseWriter, r *http.Request) {
	...
	proxyInfoResp.Proxies = svr.getProxyStatusByType(proxyType)
...
func (svr *Service) getProxyStatusByType(proxyType string) (proxyInfos []*ProxyStatsInfo) {
...
type GetProxyStatsResp struct {
	...
	Conf            interface{} `json:"conf"`
	TodayTrafficIn  int64       `json:"todayTrafficIn"`
	TodayTrafficOut int64       `json:"todytTrafficOut"`
	CurConns        int64       `json:"curConns"`
	LastStartTime   string      `json:"lastStartTime"`
	LastCloseTime   string      `json:"lastCloseTime"`
	Status          string      `json:"status"`
...
func (svr *Service) apiProxyByTypeAndName(w http.ResponseWriter, r *http.Request) {
	...
	log.Infof("http reques: [%s]", r.URL.Path)
